...
var orderPage = function(){
    ...
    $('.order-box .order-user button').on('click', function(e){
        $('.order-box .order-user button').removeClass('active');
        $(this).addClass('active');
        if($(this).hasClass('new-user')){
            $('.register-user-form-wrap').fadeOut(100);
            $('.new-user-form-wrap').fadeIn(300);
        } else if($(this).hasClass('register-user')){
            $('.register-user-form-wrap').fadeIn(300);
            $('.new-user-form-wrap').fadeOut(100);
        }
    });
};
